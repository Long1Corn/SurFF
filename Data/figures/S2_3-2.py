...
# Example DataFrame
csv_pth = [r"Data/Surface/Surface_Energy/slab_data_1.csv",
           r"Data/Surface/Surface_Energy/slab_data_2.csv",
           r"Data/Surface/Surface_Energy/slab_data_3.csv",
           ]
...
plt.title('Composition System Distribution', fontsize=24)  # Adjust fontsize as needed
plt.xlabel('Element', fontsize=24)  # Adjust fontsize as needed
plt.ylabel('Element', fontsize=24)  # Adjust fontsize as needed
...
plt.tight_layout()
plt.savefig(r"Data/figures/fig_save/S2_3-2.png")
